        ...
        <CardContent className="pt-6">
          <div className="flex gap-4 items-end flex-wrap">
            ...
            <div className="flex gap-2">
              <Button onClick={handleFilter} disabled={loading} className="bg-blue-600 hover:bg-blue-700 text-white gap-1">
      ...
      {fetched && (
        <>
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              { label: 'إجمالي الأوامر', value: totalOrders, color: 'text-blue-600', bg: 'bg-blue-50' },
                  ...
                  <tbody>
                    {rows.map((r, i) => (
                      <tr key={i} className="border-t">
                        ...
                        <td className="p-2 text-center text-gray-600">{r.office_name || '-'}</td>
                        <td className="p-2 text-center text-blue-600 font-medium">{r.total_orders}</td>
                    ...
                    {rows.length > 0 && (
                      <tr className="bg-gray-50 font-bold border-t">
                        ...
                        <td className="p-2 text-center text-blue-700">{totalOrders}</td>
