...
export function PrintButton() {
  return (
    <button
      ...
      className="fixed top-4 left-4 z-50 print:hidden bg-[#cd7f32] hover:bg-[#b56b20] text-white text-sm font-medium px-4 py-2 rounded-lg shadow-lg gap-2 inline-flex items-center"
    >
